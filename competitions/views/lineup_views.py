...
class MatchReportViewSet(viewsets.ModelViewSet):
    ...
    def create_report(self, request, *args, **kwargs):
        ...
        try:
            ...
            data_payload = dict(report.data or {})
            if 'incidents' in serializer.validated_data:
                data_payload['incidents'] = serializer.validated_data['incidents']
            if 'notes' in serializer.validated_data:
                data_payload['notes'] = serializer.validated_data['notes']
            report.data = data_payload
