...
class Match(BaseModel):
    ...
    class MatchPeriod(models.TextChoices):
        ...
        EXTRA_FIRST_HALF = "extra_first_half", "1º período do prolongamento"
        EXTRA_HALFTIME = "extra_halftime", "Intervalo do prolongamento"
        EXTRA_SECOND_HALF = "extra_second_half", "2º período do prolongamento"
