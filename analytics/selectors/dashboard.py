"""
BOLAYETU — Dashboard Analytics Selector

Core KPI queries for dashboards (per-tenant, per-competition, per-club).
Migrated from analytics/selectors.py to analytics/selectors/dashboard.py.
"""
