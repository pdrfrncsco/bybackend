...
class Command(BaseCommand):
    help = 'Gera clubes de Angola para um tenant específico'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Seed de clubes de Angola executado para tenant {tenant.slug}: {total_clubs} clubes'))
