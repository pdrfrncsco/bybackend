    ...
    def handle(self, *args, **options):
        organizations_data = [
            ...
            },
            {
                ...
                'description': 'Liga profissional de clubes angolanos.',
                'is_public': True,
                'verified': True,
            },
            {
            ...
            },
            {
                ...
                'description': 'Liga escolar para clubes de formação em Benguela.',
                'is_public': True,
                'verified': False,
            },
            {
            ...
            },
            {
                ...
                'secondary_color': '#111827',
                'description': 'Competição provincial de clubes do Huambo.',
                'is_public': True,
                'verified': False,
            },
            {
                ...
                'secondary_color': '#1e293b',
                'description': 'Liga amadora voltada para clubes de bairro em Luanda.',
                'is_public': True,
                'verified': False,
            },
            {
                ...
                'primary_color': '#22c55e',
                'secondary_color': '#0f172a',
                'description': 'Liga amadora com clubes da província de Benguela.',
                'is_public': True,
                'verified': False,
            },
            {
            ...
            },
            {
                ...
                'primary_color': '#22c55e',
                'secondary_color': '#0f172a',
                'description': 'Liga distrital focada em clubes do Cazenga.',
                'is_public': True,
                'verified': False,
            },
            {
                ...
                'primary_color': '#3b82f6',
                'secondary_color': '#020617',
                'description': 'Liga local que integra clubes de Viana.',
                'is_public': True,
                'verified': False,
            },
            {
                ...
                'primary_color': '#22c55e',
                'secondary_color': '#111827',
                'description': 'Competição nacional de clubes Sub-20.',
                'is_public': True,
                'verified': False,
            },
            {
                ...
                'primary_color': '#f97316',
                'secondary_color': '#0f172a',
                'description': 'Competição nacional de clubes Sub-17.',
                'is_public': True,
                'verified': False,
            },
        ]
