...
@extend_schema_view(
    list=extend_schema(
        tags=["Clubs"],
        description="Lista clubs do tenant atual. Requer utilizador autenticado."
    ),
...
class ClubViewSet(viewsets.ModelViewSet):
    ...
    @extend_schema(
        tags=["Clubs"],
        description="Lista resumida de clubs com sigla e nome curto.",
...
@extend_schema_view(
    list=extend_schema(
        ...
        description="Lista histórico de clubs do tenant atual. Requer permissões de gestão (MANAGER/ADMIN)."
    ),
    retrieve=extend_schema(
        tags=["Club History", "Admin/Manager Only"],
